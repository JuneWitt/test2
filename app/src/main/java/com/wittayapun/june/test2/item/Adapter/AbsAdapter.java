...
public class AbsAdapter extends RecyclerView.Adapter<SetViewHolder> {
    ...
    public AbsAdapter(Activity activity, List<Item> items,OnTapListener onTapListener) {
    ...
    public SetViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_list_item_abs, parent, false);
