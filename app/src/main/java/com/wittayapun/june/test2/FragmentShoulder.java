...
public class FragmentShoulder extends Fragment implements OnTapListener {
    View view;
    ...
    public void loadDatabase() {
        ...
        adapter = new ShoulderAdapter(getActivity(), shoulderList,getContext(),this);
    ...
    public void OnTapView(View view, int position) {
        Intent shoulderIntent = new Intent(getActivity(),ChestDetailActivity.class);
        shoulderIntent.putExtra("ID",shoulderList.get(position).getId()+"");
